...
class DetailBooking extends StatelessWidget {
  ...
  String formattedDateVerbose = DateFormat('d MMMM yyyy').format(DateTime.now());
      ...
      Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Hotel/Event photo',


              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
            ),
            Text(
              ' $formattedDateVerbose',
  ...
  Widget _buildOrderSummary(String title, String value, {bool isTotal = false}) {
    return Padding(
