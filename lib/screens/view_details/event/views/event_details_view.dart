...
class _EventDetailsPageState extends State<EventDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.ios_share, color: Color.fromARGB(255, 13, 13, 13)),
  ...
  Widget _buildTicketCounterCard() {
    final isExpired = _viewModel.isEventExpired;
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: isExpired 
                  ? Colors.grey 
                  : _viewModel.ticketsRemaining > 0 ? Colors.green : Colors.red,
            ),
          ),
          const SizedBox(height: 12),
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: isExpired
                    ? null
                    : _viewModel.ticketCount > 1
                        ? () => setState(() => _viewModel.decreaseTicketCount())
                        : null,
                color: isExpired
                    ? Colors.grey[400]
                    : _viewModel.ticketCount > 1 ? Colors.deepOrange : Colors.grey[400],
              ),
              ...
              IconButton(
                ...
                onPressed: isExpired
                    ? null
                    : _viewModel.canAddMoreTickets
                        ? () => setState(() => _viewModel.increaseTicketCount())
                        : null,
                color: isExpired
                    ? Colors.grey[400]
                    : _viewModel.canAddMoreTickets ? Colors.deepOrange : Colors.grey[400],
              ),
            ],
          ),
          const SizedBox(height: 12),
        ...
        onPressed: isDisabled ? null : () async {
          ...
          try {
            ...
            notificationViewModel.addNotification(
              ...
              message: 'Your booking for ${_viewModel.model.name} has been confirmed',
              type: 'booking',
              actionRoute: '/event/${widget.eventId}',
            );
