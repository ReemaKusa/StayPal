...
class _HotelDetailsPageState extends State<HotelDetailsPage> {
  ...
  Widget _buildImageSlider() {
    return SizedBox(
      ...
      bottomNavigationBar: CustomNavBar(currentIndex: 1, searchKey: GlobalKey()),
    );
  }
      ...
      itemBuilder: (context, index) {
        return CachedNetworkImage(
          ...
          errorWidget: (context, url, error) =>
              Container(color: Colors.grey[200], child: const Icon(Icons.error_outline, color: Colors.red)),
        );
      },
    );
  }
      ...
      children: [
        ...
        Wrap(
          ...
          children: _facilities.map((facility) {
            final key = facility.toString().toLowerCase().replaceAll(" ", "_");
            final iconPath = 'assets/icons/$key.svg';
            return Container(
